...
class TestMultirep(TestCase):
    ...
    def test_wlk(self):
        ...
        expected = (np.array([0.05421]), np.array([0.10994]), np.array([0.2395]))
        eval_HINVE = np.array([0.6])
        actual = wlk_two_moment_null_approx(2, 1, 2, 5, eval_HINVE, 0.05)
        actual.glmmpcl(
            alphatest=0.05,
            dfh=20,  # df1
            n2=5,  # total_N ??? what is this
    ...
    def test_wlk(self):
        ...
        expected = (np.array([0.05421]), np.array([0.10994]), np.array([0.2395]))
        eval_HINVE = np.array([0.6])
        actual = wlk_two_moment_null_approx_obrien_shieh(2, 1, 2, 5, eval_HINVE, 0.05)
        actual.glmmpcl(
            alphatest=0.05,
            dfh=20,  # df1
            n2=5,  # total_N ??? what is this
    ...
    def test_special(self):
        ...
        expected = (np.array([0.05421]), np.array([0.10994]), np.array([0.2395]))
        eval_HINVE = np.array([0.6])
        actual = special(2, 1, 2, 5, eval_HINVE, 0.05)
        actual.glmmpcl(
            alphatest=0.05,
            dfh=20,  # df1
            n2=5,  # total_N ??? what is this
